import 'package:localeventsapp/model/event_schedule.dart';
...
final fiveKmRunEvent = Event(
    ...
    galleryImages: [],
    categoryIds: [0, 1],
    eventSchedule: [EventSchedule("3.00 PM","Introduction Event")
      ,EventSchedule("4.00 PM","Main Event"),EventSchedule("5.00 PM","Introduction Event")]);
...
final musicConcert = Event(
    ...
    punchLine2: "The latest fad in foodology, get the inside scoup.",
    galleryImages: ["assets/event_images/cooking_1.jpeg", "assets/event_images/cooking_2.jpeg", "assets/event_images/cooking_3.jpeg"],
    categoryIds: [0, 1], eventSchedule: [EventSchedule("3.00 PM","Introduction Event")
  ,EventSchedule("3.00 PM","Main Event")]);
...
final golfCompetition = Event(
    ...
    categoryIds: [0, 3],
    eventSchedule: [EventSchedule("3.00 PM","Introduction Event")
  ,EventSchedule("4.00 PM","Main Event")]);
